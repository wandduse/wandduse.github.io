const config = {
  ...
  <body>
    ...
    <p> <a href="https://www.wanuse.com" target="_self">博客</a> </p>
    <p> <a href="https://www.youtube.com/channel/UCGPeyWXeSe_eqX6wmsilAFg/" target="_self">YouTube</a> </p>
    <p> <a href="https://space.bilibili.com/1075183948?spm_id_from=333.1007.0.0">哔哩哔哩</a> </p>
  </body>
  </html>`
  ...
  async function handleRequest(request) {
    ...
    // 如果path符合password 显示应用界面x
    if (path==password_value){  
      let index= await fetch("https://cdn.jsdelivr.net/gh/wandduse/wandduse.github.io/dlj/"+config.theme+"/index.html")
    ...
    if (location) {
      if (config.no_ref=="on"){
        let no_ref= await fetch("https://cdn.jsdelivr.net/gh/wandduse/wandduse.github.io/dlj/no-ref.html")
